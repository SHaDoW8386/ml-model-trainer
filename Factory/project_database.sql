...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$390000$6A0NlDjIMloQOt24ZR7jDk$MDmsRxUWXGyMruttcgNEofy7LICPCFNwIHCUAobYFgE=','2022-11-07 15:21:34.691736',1,'admin','','','',1,1,'2022-11-03 11:13:35.913282');
...
INSERT INTO `authentication_user` VALUES ('U101','Shobha Dhande','+916232626660','shobhadhande11@gmail.com','12345678');
...
CREATE TABLE `home_demomodel` (
  ...
  PRIMARY KEY (`id`),
  KEY `Home_demomodel_NAME_id_6c034842_fk_Home_informationmodel_id` (`NAME_id`),
  CONSTRAINT `Home_demomodel_NAME_id_6c034842_fk_Home_informationmodel_id` FOREIGN KEY (`NAME_id`) REFERENCES `home_informationmodel` (`id`)
...
INSERT INTO `home_demomodel` VALUES (2,'{\"data\": \"value\"}',3);
...
INSERT INTO `home_informationmodel` VALUES (3,'Hello this is vishal singh','aergqer','qergqer','qergqerg','P01','WINNING TEAM PREDICTION');
...
INSERT INTO `home_projectsmodel` VALUES ('P01','Winning Team Prediction','Images/India-vs-pakistan-770x433_zCie79n.webp','G10'),('P02','UBER DATA ANALYSIS','Images/uber_data_analysis_HY4lKBg.jpeg','G10'),('P03','HOUSE PRICE PREDICTION','Images/house_price_prediction_WXpjUVd.jpg','G10'),('P04','FLOWER SPECIES CLASSIFICATION','Images/flowe_prediction_h6sGpsM.png','G10'),('P11','FACE MASK DETECTION','Images/face-mask_detection_RgXiVuC.png','G11'),('P12','ATTENDENCE MONITORING SYSTEM','Images/attendance_system_PaCUvep.jpg','G11'),('P13','DIGIT RECOGNITION','Images/digit_recognistion_images_dumkfsc.jpg','G11'),('P14','DOGS BREED PREDICTION','Images/dog_breed_prediction_YScYbLu.jpeg','G11'),('P21','LIBRARY MANAGEMENT SYSTEM','Images/library_management_system_DV3Ch9O.png','G12'),('P22','BANK APPLICATION','Images/bank_application_system_jdoTWL0.webp','G12'),('P23','WEATHER APPLICATION','Images/weather_application_system_al14juL.jpg','G12'),('P24','BASIC CALCULATOR','Images/basic_calculator_z7nbpfK.jpg','G12'),('P31','ROCK PAPER SCISSOR','Images/rock_paper_scissor_d00Jy1n.webp','G13'),('P32','SNAKE GAME','Images/snake_game_d0Yhr2E.jpg','G13'),('P33','TIK TAK TOE','Images/tiktaktoe.png','G13'),('P34','SNAKE AND LADDER GAME','Images/snake_Ti6WDnm.webp','G13');
...
-- Dump completed on 2022-11-07 21:01:26
